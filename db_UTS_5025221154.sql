...
MySQL - 10.4.32-MariaDB : Database - db_uts_5025221154
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_uts_5025221154` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;

USE `db_uts_5025221154`;
...
) ENGINE=InnoDB AUTO_INCREMENT=10444 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

/*Data for the table `orders` */

insert  into `orders`(`OrderID`,`CustomerID`,`EmployeeID`,`OrderDate`,`ShipperID`) values 
(10248,90,11,'1996-07-04',3),
...
insert  into `users`(`user_id`,`user_name`,`user_password`,`user_phonenumber`) values 
('1','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('10','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('11','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('17','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('18','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('19','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('2','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('3','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('30','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('5025221153','Helsa','201c3ccc787a7acf9c1e7a1d437fcc60','081319156659'),
('5025221154','Helsa','df8e62fbf72e4228a500a3fbefbe5fb2','081319156659'),
('5025221157','Helsa','d0023d08291d86e8d4e5882a9b67a304','081319156659'),
('dosen','Your Lecturer','df8e62fbf72e4228a500a3fbefbe5fb2','0811332311'),
('guest','Guest User','df8e62fbf72e4228a500a3fbefbe5fb2','12345678');

/*Table structure for table `users_log_login_status` */

DROP TABLE IF EXISTS `users_log_login_status`;

CREATE TABLE `users_log_login_status` (
  ...
  `password_salah` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

/*Data for the table `users_log_login_status` */

insert  into `users_log_login_status`(`user_id`,`tgljam`,`login_status`,`password_salah`) values 
('guest','2024-05-15 13:42:09','gagal','nyoba lagi'),
('guest','2024-05-15 13:42:19','gagal','guest'),
('guest','2024-05-15 13:43:01','sukses',NULL),
('18','2024-05-15 17:17:02','Sukses: Lo','d0023d08291d86e8d4e5882a9b67a3'),
('18','2024-05-15 17:17:47','Sukses: Lo','d0023d08291d86e8d4e5882a9b67a3'),
('19','2024-05-15 17:19:20','Sukses: Lo','d0023d08291d86e8d4e5882a9b67a3'),
('19','2024-05-15 17:19:57','Sukses: Lo','d0023d08291d86e8d4e5882a9b67a3');

/*Table structure for table `users_log_password` */

DROP TABLE IF EXISTS `users_log_password`;

CREATE TABLE `users_log_password` (
  `users_id` varchar(30) DEFAULT NULL,
  `old_password` char(32) DEFAULT NULL,
  `new_password` char(32) DEFAULT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

/*Data for the table `users_log_password` */

insert  into `users_log_password`(`users_id`,`old_password`,`new_password`,`timestamp`) values 
('guest','d41d8cd98f00b204e9800998ecf8427e','d41d8cd98f00b204e9800998ecf8427a','2024-05-15 13:19:24'),
('guest','d41d8cd98f00b204e9800998ecf8427a','d41d8cd98f00b204e9800998ecf8427b','2024-05-15 13:19:27'),
('guest','d41d8cd98f00b204e9800998ecf8427b','d41d8cd98f00b204e9800998ecf8427e','2024-05-15 13:19:35'),
('guest','d41d8cd98f00b204e9800998ecf8427e','ac43724f16e9241d990427ab7c8f4228','2024-05-15 13:30:37'),
('guest','ac43724f16e9241d990427ab7c8f4228','6f5128a862d60cfafafcaf8b7427719c','2024-05-15 13:55:58'),
('guest','6f5128a862d60cfafafcaf8b7427719c','ac43724f16e9241d990427ab7c8f4228','2024-05-15 13:56:09'),
('5025221154','d0023d08291d86e8d4e5882a9b67a304','helsasp1234','2024-05-15 16:07:32'),
('5025221154','helsasp1234','df8e62fbf72e4228a500a3fbefbe5fb2','2024-05-15 16:08:57'),
('dosen','3945af1c3186c0a74ea4aa10ed2714c4','df8e62fbf72e4228a500a3fbefbe5fb2','2024-05-15 16:08:57'),
('guest','ac43724f16e9241d990427ab7c8f4228','df8e62fbf72e4228a500a3fbefbe5fb2','2024-05-15 16:08:57'),
('5025221153','d0023d08291d86e8d4e5882a9b67a304','201c3ccc787a7acf9c1e7a1d437fcc60','2024-05-15 16:46:44');

/* Trigger structure for table `users` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `trg_users_log_password` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `trg_users_log_password` BEFORE UPDATE ON `users` FOR EACH ROW 
BEGIN
   
    IF OLD.user_password <> NEW.user_password THEN
        INSERT INTO users_log_password (users_id, OLD_PASSWORD, new_password, TIMESTAMP)
        VALUES (OLD.user_id, OLD.user_password, NEW.user_password, NOW());
    END IF;
END */$$
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_login`(
    ...
    IN p_user_password CHAR(32)
)
BEGIN
    DECLARE v_user_id VARCHAR(30);
    DECLARE v_user_password CHAR(32);
    ...
    IF v_user_id IS NULL THEN
        SELECT 'Gagal: User tidak ditemukan' AS Result;
 
    ELSEIF v_user_password != p_user_password THEN
        SELECT 'Gagal: Password salah' AS Result;
   
    ELSE
        SELECT 'Sukses: Login berhasil' AS Result;
    END IF;
    
END */$$
DELIMITER ;

/* Procedure structure for procedure `sp_login_v2` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_login_v2` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_login_v2`(
    IN p_user_id VARCHAR(30),
    IN p_user_password CHAR(32)
)
BEGIN
    ...
    IF v_user_id IS NULL THEN
        SET v_login_status = 'Gagal: User tidak ditemukan';
        INSERT INTO users_log_login_status (user_id, tgljam, login_status, password_salah)
        VALUES (p_user_id, NOW(),v_login_status, p_user_password);
 
    ELSEIF v_user_password != p_user_password THEN
        SET v_login_status = 'Gagal: Password salah';
        INSERT INTO users_log_login_status (user_id, tgljam, login_status, password_salah)
        VALUES (p_user_id, NOW(),v_login_status, p_user_password);
 
   
    ELSE
        SET v_login_status = 'Sukses: Login berhasil';
        INSERT INTO users_log_login_status (user_id, tgljam, login_status, password_salah)
       VALUES (p_user_id, NOW(),v_login_status, p_user_password);
 
    END IF;
    
    SELECT v_login_status AS Result;
    
END */$$
DELIMITER ;

/* Procedure structure for procedure `sp_setPassword` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_setPassword` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_setPassword`(IN user_id VARCHAR(30), IN user_newpassword CHAR(32))
BEGIN
  
    UPDATE users
    SET user_password = MD5(user_newpassword)
    WHERE user_id = user_id;
END */$$
DELIMITER ;

/* Procedure structure for procedure `sp_ubahPassword` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_ubahPassword` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ubahPassword`(IN p_user_id VARCHAR(30), IN p_user_oldpassword CHAR(32), IN p_user_newpassword CHAR(32))
BEGIN
    DECLARE v_old_password CHAR(32);
    DECLARE v_new_password CHAR(32);
    DECLARE v_login_message VARCHAR(255);

    SELECT user_password INTO v_old_password
    FROM users
    WHERE user_id = p_user_id;
    
    IF v_old_password <> MD5(p_user_oldpassword) THEN
        SET v_login_message = 'Gagal mengubah password. Password lama tidak cocok.';
    ELSE
        UPDATE users
        SET user_password = MD5(p_user_newpassword)
        WHERE user_id = p_user_id;

        SET v_login_message = 'Sukses mengubah password.';
    END IF;
    SELECT v_login_message AS 'Status';
END */$$
DELIMITER ;

...
MySQL - 10.4.32-MariaDB : Database - db_uts_no2_5025221154
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_uts_no2_5025221154` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;

USE `db_uts_no2_5025221154`;
...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `FK_OrderDetails_Order` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_OrderDetails_Product` FOREIGN KEY (`ProductID`) REFERENCES `products` (`ProductID`) ON UPDATE CASCADE
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `FK_Orders_Customers` FOREIGN KEY (`CustomerID`) REFERENCES `customers` (`CustomerID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_Orders_Shipper` FOREIGN KEY (`ShipperID`) REFERENCES `shippers` (`ShipperID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_Orders_Shippers` FOREIGN KEY (`ShipperID`) REFERENCES `shippers` (`ShipperID`) ON DELETE SET NULL ON UPDATE CASCADE
...
('5025221154','Helsa Putri','8436a2bdb0b1342221ddd550acf82236','0813191566559'),
('dosen','Your Lecturer','3945af1c3186c0a74ea4aa10ed2714c4','0811332311'),
('guest','Guest User','ac43724f16e9241d990427ab7c8f4228','12345678');
